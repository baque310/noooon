  ...
  const chartData = [
    {
      ...
      value: data?.attendanceCounts.month.Absent ?? 0,
      fill: "#c42727"
    },
    {
      name: t("DashboardPage.present"),
      value: data?.attendanceCounts.month.Present ?? 0,
      fill: "#2aab68",
    },
    {
      name: t("DashboardPage.vacation"),
      value: data?.attendanceCounts.month.Vacation ?? 0,
      fill: "#2544a3",
    },
