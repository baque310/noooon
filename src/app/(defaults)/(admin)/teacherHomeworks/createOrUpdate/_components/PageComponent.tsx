      ...
      {isFetching || isFetchingSettings ? (
        ...
        <Formik<FormValues>
          ...
          {(props: FormikProps<any>) => (
            <Form className={isModal ? "space-y-4" : "space-y-6"}>
              ...
              {isModal ? (
                ...
                <>
                  {/* Regular Page Mode - Original Structure */}
                  <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    <div className="border-b border-gray-200 bg-gradient-to-r from-blue-50 to-transparent p-6 dark:border-gray-700 dark:from-blue-900/20">
                      <div className="flex items-center gap-4">
                        ...
                        <h2 className="text-xl font-semibold text-gray-900 dark:text-white">{t("TeacherHomeworksPage.infoTeacherHomeworks")}</h2>
                      </div>
                    </div>
