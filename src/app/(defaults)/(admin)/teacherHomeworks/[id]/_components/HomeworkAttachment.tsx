...
export const HomeworkAttachment = ({
  data,
}: {
  ...
  const [
    ...
    { isLoading: isLoadingTeacherHomeworksAttachmentsRemove },
  ] = useTeacherHomeworksAttachmentsRemoveMutation();

  const handleRemove = async () => {
    try {
      await TeacherHomeworksAttachmentsRemove({
        teacherId: data?.teacherSubject.Teacher.id as any,
        body: {
  ...
  if (!data?.HomeworkAttachment || data.HomeworkAttachment.length === 0) {
    return (
              ...
              <div className="flex items-center gap-3 w-full">
                ...
                <div>
                  <h2 className="text-lg font-bold bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">
                    {t("TeacherHomeworksPage.HomeworkAttachment")}
                  </h2>
                  <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">
                    {t("TeacherHomeworksPage.Assignment attachments gallery")}
                  </p>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <h3 className="text-lg font-bold bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">
                    {t("TeacherHomeworksPage.No attachments available")}
                  </h3>
                  <p className="text-gray-500 dark:text-gray-400 max-w-sm mx-auto">
                    {t(
                      "TeacherHomeworksPage.This homework doesn't have any attached images"
                    )}
                  </p>
                </div>
              </div>
  ...
  return (
    <div className="relative mt-4">
      ...
      <div className="relative backdrop-blur-sm bg-white/80 dark:bg-gray-900/80 rounded-2xl shadow-xl border border-white/20 dark:border-gray-700/30 overflow-hidden">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {data.HomeworkAttachment.map((item, index) => (
              <div
                key={index}
      ...
      <DeleteModel
        description={t(
          "TeacherHomeworksPage.Are-you-sure-you-want-to-delete-this-attachment"
        )}
        title={t("TeacherHomeworksPage.DeleteAttachment")}
        open={openDelete}
...
export const AddAttachment = ({
  ...
  return (
    <label
      htmlFor="homework-attachment-upload"
    ...
    >
      ...
      {t("TeacherHomeworksPage.AddAttachment")}
      <input
        id="homework-attachment-upload"
        type="file"
        accept="image/*"
        className="hidden"
