...
const useLogic = () => {
    ...
    const [StudentGetDataById, { currentData: DataStudentGetDataById, isFetching }] = useLazyStudentGetDataByIdQuery()
    useEffect(() => {
        if (id) {
    ...
    console.log("data.data", DataStudentGetDataById);
    ...
    return {
        ...
        studentSchema,
        handleSubmit,
        isLoadingStudentUpdate: isLoadingStudentUpdate || isLoadingStudentCreate,
        selected,
        setSelected,
        handleSubmitMulti,
        studentSchemaMulti,
