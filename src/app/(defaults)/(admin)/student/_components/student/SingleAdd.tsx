...
import { FormValues } from "./StudentAddEdit";
            ...
            <div className="relative p-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">{t("StudentPage.enterStudentPersonalInfo")}</p>
                </div>
              </div>

              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <InputForm formikProps={props} name={"fullName"} title={t("StudentPage.fullName")} placeholder={t("StudentPage.enter-fullName")} />
                <DateTimeForm formikProps={props} name={"birth"} title={t("StudentPage.birth")} placeholder={t("StudentPage.enter-birth")} />

                <DateTimeForm formikProps={props} name={"enrollmentDate"} title={t("StudentPage.enrollmentDate")} placeholder={t("StudentPage.enter-enrollmentDate")} />
                <SelectForm
                  formikProps={props}
                  name={"gender"}
                  className=""
            ...
            <div className="relative p-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">{t("StudentPage.contactDetailsAndAddress")}</p>
                </div>
              </div>

              <div className="space-y-6">
                <InputForm formikProps={props} name={"address"} title={t("StudentPage.address")} placeholder={t("StudentPage.enter-address")} />
                <InputForm formikProps={props} name={"email"} title={t("StudentPage.email")} placeholder={t("StudentPage.enter-email")} />
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <InputForm
                    formikProps={props}
                    name={"phone1"}
              ...
              <div className="relative p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">{t("StudentPage.uploadStudentProfilePicture")}</p>
                  </div>
                </div>

                <UploadFileForm valueFileName={props.values.photo} formikProps={props} name={"photo"} title={t("StudentPage.photo")} placeholder={""} />
              </div>
            </div>
          )}
