...
import { FormValuesMulti } from "./StudentAddEdit";
        ...
        <Form className={"px-4 flex flex-col gap-8"}>
            ...
            <div className="relative flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">{t("StudentPage.addMultipleStudentsDesc")}</p>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl p-6 border border-purple-100 dark:border-purple-800/30">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="text-lg font-semibold text-purple-800 dark:text-purple-300">{t("StudentPage.parentInfo")}</h4>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <InputForm className="w-full" formikProps={props} name={`p_name`} title={t("StudentPage.parentFullName")} placeholder={t("StudentPage.enter-parentFullName")} />
              <InputForm
                className="w-full"
                formikProps={props}
                name={`p_phone`}
                            ...
                            <div className="flex justify-between items-center">
                              <div className="flex items-center gap-4">
                                ...
                                <div>
                                  ...
                                  <p className="text-gray-500 dark:text-gray-400 text-sm">{t("StudentPage.completeStudentParentInfo")}</p>
                                </div>
                              </div>
                        ...
                        <div className="p-6 space-y-6">
                          ...
                          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl p-6 border border-blue-100 dark:border-blue-800/30">
                            <div className="flex items-center gap-3 mb-4">
                              ...
                              <h4 className="text-lg font-semibold text-blue-800 dark:text-blue-300">{t("StudentPage.studentInfo")}</h4>
                            </div>
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                              <InputForm
                                className="w-full"
