    ...
    ...id ? {
      ...
      ExamSection: Yup.array()
        ...
        .test('at-least-one', t('common.at-least-oneDay-required-content-subject'), (value) =>
          value?.some((item) => item !== null && item.sectionId && item.examDate)
        ),
                ...
                {!id ? <>
                  <div className="Card flex flex-col gap-1">
                    ...
                    <SelectForm
                      ...
                      options={StageSubject?.map((item, index) => {
                        return {
                  ...
                  </div>
                  {
                    ...
                    <div className="mt-[2px] w-full p-1 text-sm text-danger">{t((props?.errors?.ExamSection ?? "") as any)}</div>
                  }
                  <div
                        ...
                        {props.values.ExamSection?.map((_: any, index: number) => {
                          ...
                          return (
                            <div key={index} className="">
                              ...
                              >
                                {_.examDate || _.sectionValue ? <bdi className=' flex gap-1'>
                                  <bdi>
                                    {t(_.examDate)}
                                  </bdi>
                                  {_.sectionValue &&
