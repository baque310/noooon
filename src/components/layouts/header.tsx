...
export const Header = () => {
    ...
    return (
        <header className={`z-40 ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''} shadow-base `}>
                    ...
                    <div className="flex items-center justify-end space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
                        ...
                        <div className="dropdown flex shrink-0">
                            <Dropdown offset={[0, 8]} placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`} btnClassName="relative group block"
                                button={<div className="h-9 w-9 rounded-full object-cover saturate-50 group-hover:saturate-100 flex justify-center items-center bg-purple-700/20 text-purple-700" >
