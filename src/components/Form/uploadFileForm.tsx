  ...
  return (
    ...
    >
      <label className="font-normal" htmlFor={name}>
        {title} <span className="text-danger">(10MB)</span>
      </label>
      <div className="relative w-full">
        <Upload
          accept={accept}
          className={`${
            image ? "h-[150px!important]" : "h-[50px!important]"
          } w-[100%!important] rounded-md border border-base border-dashed hover:border-primary ${
            formikProps.submitCount
